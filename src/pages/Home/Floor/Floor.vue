      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li class="active" v-for="(item,index) in floordata.navList" :key="index">
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(item,index) in floordata.keywords" :key="index">{{item}}</li>
              </ul>
              <img :src="floordata.imgUrl" />
            </div>
            <div class="floorBanner">
              <Carousel :carousel='floordata.carouselList'/>
            </div>
            <div class="split">
